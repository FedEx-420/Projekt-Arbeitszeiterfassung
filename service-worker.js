const CACHE = 'arbeitszeit-neu-v800';
const FILES = ['./','./index.html','./styles-v700.css','./responsive-v701.css','./navigation-v710.css','./menu-v720.css','./app-v800.js?v=800','./config.js?v=600','./manifest.webmanifest','./icon.svg'];
