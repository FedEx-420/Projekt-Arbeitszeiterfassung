const CACHE = 'arbeitszeit-neu-v734';
const FILES = ['./','./index.html','./styles-v700.css','./responsive-v701.css','./navigation-v710.css','./menu-v720.css','./app-v700.js?v=734','./config.js?v=600','./manifest.webmanifest','./icon.svg'];
