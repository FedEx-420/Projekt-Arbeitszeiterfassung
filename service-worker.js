const CACHE = 'arbeitszeit-neu-v710';
const FILES = ['./','./index.html','./styles-v700.css','./responsive-v701.css','./navigation-v710.css','./app-v700.js?v=710','./config.js?v=600','./manifest.webmanifest','./icon.svg'];
