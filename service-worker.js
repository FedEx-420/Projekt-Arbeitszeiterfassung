const CACHE = 'arbeitszeit-platform-v500'
const FILES = ['./', './index.html', './styles-platform.css?v=500', './app-platform.js?v=500', './config.js?v=1', './manifest.webmanifest', './icon.svg']
