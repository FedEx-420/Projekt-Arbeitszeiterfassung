...
(() => {
  ...
  const state = {
    ...
    businessId: '', employeeId: '', customerId: '', orderId: '', orderOrigin: 'orders', menu: false, vacationForm: false, appointmentForm: false, notice: null, busy: false,
  ...
  function viewHtml() { return ({ home: homeView, time: timeView, orders: ordersView, 'order-detail': orderDetailView, calendar: calendarView, customers: customersView, mailbox: mailboxView, materials: materialsView, invoices: invoicesView, settings: settingsView }[state.view] || homeView)(); }
  ...
  root.addEventListener('click', event => {
    ...
    if (action === 'nav') { state.view = button.dataset.view; state.menu = false; state.vacationForm = false; state.orderId = ''; state.orderOrigin = 'orders'; render(); return; }
