const CACHE_NAME = "arbeitszeit-neu-v106";
const APP_FILES = ["./", "./index.html", "./styles-new.css?v=103", "./styles-week.css?v=103", "./styles-104.css?v=104", "./app-new.js?v=106", "./config.js?v=1", "./manifest.webmanifest", "./icon.svg"];
