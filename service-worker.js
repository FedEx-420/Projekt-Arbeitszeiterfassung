const CACHE = 'arbeitszeit-neu-v808';
const FILES = ['./','./index.html','./styles-v700.css','./responsive-v701.css','./navigation-v710.css','./menu-v720.css','./calendar-v800.css?v=2','./app-v800.js?v=808','./config.js?v=600','./manifest.webmanifest','./icon.svg'];
