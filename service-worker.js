const CACHE = 'arbeitszeit-neu-v802';
const FILES = ['./','./index.html','./styles-v700.css','./responsive-v701.css','./navigation-v710.css','./menu-v720.css','./calendar-v800.css?v=1','./app-v800.js?v=802','./config.js?v=600','./manifest.webmanifest','./icon.svg'];
