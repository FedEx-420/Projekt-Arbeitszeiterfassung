const CACHE_NAME = "arbeitszeit-neu-v103";
const APP_FILES = ["./", "./index.html", "./styles-new.css?v=103", "./styles-week.css?v=103", "./app-new.js?v=103", "./config.js?v=1", "./manifest.webmanifest", "./icon.svg"];
